...
//		configuration.setProperty("hibernate.default_schema", System.getenv("proj2_SCHEMA"));
		...
		Configuration configuration = new Configuration().configure();
		configuration.setProperty("hibernate.connection.url", "REDACTED");
		configuration.setProperty("hibernate.connection.username","REDATCTED");
		configuration.setProperty("hibernate.connection.password", "REDACTED");
